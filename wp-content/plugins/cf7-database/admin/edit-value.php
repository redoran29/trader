...
function cf7d_admin_after_heading_edit_field_func()
{
    ...
    <th style="width: 32px;" class="manage-column"><?php _e('Send'); ?></th>
    <?php
}
...
function cf7d_admin_after_body_edit_field_func($form_id, $row_id)
{
    ...
    <td><div class="true_loadmore" data-num="<?php echo $row_id; ?>" style="color: #0073aa; cursor: pointer;"><?php _e('Send'); ?></div></td>
    <?php
}
